...
config_path = 'ObjectDetection/config_n_weights/yolov4.cfg'
weights_path = 'ObjectDetection/config_n_weights/yolov4.weights'
...
def cb_demo(si_stream, stop_stream, files):
        with open('assets/Data/conveyor/labels.txt') as f:
            lines = f.readlines()
        ...
        if case_selector != 'Oranges':
            ...
            if uploaded_video != None:
                ...
                video_str = 'Uploadec Video'
                go_ahead = True
        else:
            orange_video = files[0]
            vid = orange_video
            # st.video(orange_video)
            video_obj = orange_video
            video_str = 'Oranges'
            go_ahead = True
